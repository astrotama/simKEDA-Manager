<?php
function laporanapbd_display_main($arg=NULL, $nama=NULL) {
	drupal_set_title('Penganggaran APBD ' . apbd_tahun_lalu() . '/' . apbd_tahun());
	//$output_form = drupal_get_form('laporanapbd_display_main_form');	
	$output_form = laporanapbd_display_main_form();	
	return drupal_render($output_form);
}


function laporanapbd_display_main_form($form, &$form_state) {
...
if(arg(1) == 'ring'){
	...
	$form['menu1']['m11']['tab11']= array(
		...
		$form['menu1']['m11']['tab11']['uraian11']= array(
			'#prefix' => '<th style="width:48%;font-size:20px">',
			'#type'         => 'item', 
			'#markup' => '<p>Uraian</p>', 
			'#suffix' => '</th>',
		...
		$form['menu1']['m11']['tab11']['anggaran11']= array(
			'#prefix' => '<th style="width:20%; color:black; font-size:20px">',
			'#type'         => 'item', 
		...
		$form['menu1']['m11']['tab11']['persen11']= array(
			'#prefix' => '<th style="width:12%; color:black; font-size:20px">',
			'#type'   => 'item', 
		...
		$form['menu1']['m11']['tab11']['row11']= array(
			'#prefix' => '<td style="font-size:20px">',
			'#type'   => 'item', 
			'#markup' => $aggskrg_u, 
			'#suffix' => '</td>',			
		);				
	...
	$form['ring']= array(
		'#type' => 'submit',
		'#value' => '<span aria-hidden="true">Ringkasan</span>',
		'#attributes' => array('class' => array('btn btn-success btn-sm')),
	);
	$form['pen']= array(
		'#type' => 'submit',
		'#value' => '<span aria-hidden="true">PENDAPATAN</span>',
		'#attributes' => array('class' => array('btn btn-success btn-sm')),
	);
	$form['bel']= array(
		'#type' => 'submit',
		'#value' => '<span aria-hidden="true">BELANJA</span>',
		'#attributes' => array('class' => array('btn btn-success btn-sm')),
	);
	$form['bl']= array(
		'#type' => 'submit',
		'#value' => '<span aria-hidden="true">BELANJA LANGSUNG</span>',
		'#attributes' => array('class' => array('btn btn-success btn-sm')),
	);
	$form['bm']= array(
		'#type' => 'submit',
		'#value' => '<span aria-hidden="true">BELANJA MODAL</span>',
		'#attributes' => array('class' => array('btn btn-success btn-sm')),
	);
	$form['btl']= array(
		'#type' => 'submit',
		'#value' => '<span aria-hidden="true">BELANJA TIDAK LANGSUNG</span>',
		'#attributes' => array('class' => array('btn btn-success btn-sm')),
	);
	return $form;
...
function laporanapbd_display_main_form_submit($form, &$form_state) {
	if($form_state['clicked_button']['#value'] == $form_state['values']['ring']) {
		drupal_goto('laporanapbd_display/ring');
	}else if($form_state['clicked_button']['#value'] == $form_state['values']['pen']) {
		drupal_goto('laporanapbd_display/pen');
	}else if($form_state['clicked_button']['#value'] == $form_state['values']['bel']) {
		drupal_goto('laporanapbd_display/bel');
	}else if($form_state['clicked_button']['#value'] == $form_state['values']['bl']) {
		drupal_goto('laporanapbd_display/bl');
	}else if($form_state['clicked_button']['#value'] == $form_state['values']['bm']) {
		drupal_goto('laporanapbd_display/bm');
	}else if($form_state['clicked_button']['#value'] == $form_state['values']['btl']) {
		drupal_goto('laporanapbd_display/btl');
	}
